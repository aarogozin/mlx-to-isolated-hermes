...
OVERRIDE_MATRIX_MODES_SET="${MATRIX_MODES+x}"
OVERRIDE_MATRIX_MODES="${MATRIX_MODES:-}"
OVERRIDE_MATRIX_CLEAN_MODE_SET="${MATRIX_CLEAN_MODE+x}"
OVERRIDE_MATRIX_CLEAN_MODE="${MATRIX_CLEAN_MODE:-}"
OVERRIDE_MATRIX_TELEGRAM_SET="${MATRIX_TELEGRAM+x}"
OVERRIDE_MATRIX_TELEGRAM="${MATRIX_TELEGRAM:-}"
OVERRIDE_MATRIX_FINAL_ACTION_SET="${MATRIX_FINAL_ACTION+x}"
OVERRIDE_MATRIX_FINAL_ACTION="${MATRIX_FINAL_ACTION:-}"
OVERRIDE_MATRIX_RAG_SOURCE_MODE_SET="${MATRIX_RAG_SOURCE_MODE+x}"
OVERRIDE_MATRIX_RAG_SOURCE_MODE="${MATRIX_RAG_SOURCE_MODE:-}"
OVERRIDE_MATRIX_REPORT_DIR_SET="${MATRIX_REPORT_DIR+x}"
OVERRIDE_MATRIX_REPORT_DIR="${MATRIX_REPORT_DIR:-}"
...
if [[ -n "${OVERRIDE_MATRIX_MODES_SET}" ]]; then
  MATRIX_MODES="${OVERRIDE_MATRIX_MODES}"
fi
if [[ -n "${OVERRIDE_MATRIX_CLEAN_MODE_SET}" ]]; then
  MATRIX_CLEAN_MODE="${OVERRIDE_MATRIX_CLEAN_MODE}"
fi
if [[ -n "${OVERRIDE_MATRIX_TELEGRAM_SET}" ]]; then
  MATRIX_TELEGRAM="${OVERRIDE_MATRIX_TELEGRAM}"
fi
if [[ -n "${OVERRIDE_MATRIX_FINAL_ACTION_SET}" ]]; then
  MATRIX_FINAL_ACTION="${OVERRIDE_MATRIX_FINAL_ACTION}"
fi
if [[ -n "${OVERRIDE_MATRIX_RAG_SOURCE_MODE_SET}" ]]; then
  MATRIX_RAG_SOURCE_MODE="${OVERRIDE_MATRIX_RAG_SOURCE_MODE}"
fi
if [[ -n "${OVERRIDE_MATRIX_REPORT_DIR_SET}" ]]; then
