...
OVERRIDE_N8N_ENABLED_SET="${N8N_ENABLED+x}"
...
if [[ -n "${OVERRIDE_N8N_ENABLED_SET}" ]]; then
  N8N_ENABLED="${OVERRIDE_N8N_ENABLED}"
fi
...
N8N_ENABLED="${N8N_ENABLED:-${N8N_ENABLED:-0}}"
